    ...
    <footer class="bg-black border-t text-white  py-10 sm:flex justify-around">
        ...
        <div class="sm:w-4/12 ">
            ...
            <div class="grid grid-cols-2 text-sm  lg:text-center px-1">
                ...
                <p>-Consultancy and Planning Services</p>
                <p>-Renovations and Remodeling</p>
                <p>-Sewer Line Inspections and Repairs</p>
                <p>-Pipe Repairs and Leak Detection</p>
                <p>-Power Outlet and Switch Installations</p>
                <p>-Generator Installations and Maintenance</p>
                <p>-Roof Repairs and Maintenance</p>
                <p>-Painting and Finishing</p>
                <p>-Floor Repairs and Installations</p>
                <p>-Restoration of Historical Buildings</p>
                <p>-Interior Renovations</p>
