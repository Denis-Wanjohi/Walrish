    ...
    <div
        ...
        <div class="flex justify-evenly py-10">
            <div class=" w-fit text-center" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                ...
                <p class="sm:cinzel-700 cinzel-500">Expert Specialist</p>
            </div>
            <div class=" w-fit text-center" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                <p class="sm:text-[70px] text-[40px] jost-900">55+</p>
                <p class="sm:cinzel-700 cinzel-500">Successful Project</p>
            </div>
            <div class=" w-fit text-center" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                <p class="sm:text-[70px] text-[40px] jost-900">26+</p>
                <p class="sm:cinzel-700 cinzel-500">Happy Customers</p>
            </div>
        </div>
    </div>
</template>